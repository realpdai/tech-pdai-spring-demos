package tech.pdai.springboot.shardingjdbc.mybatis.tables.config;

import com.github.xiaoymin.knife4j.spring.extension.OpenApiExtensionResolver;
import tech.pdai.springboot.shardingjdbc.mybatis.tables.constants.ResponseStatus;
...
public class OpenApiConfig {
    ...
    private List<RequestParameter> getGlobalRequestParameters() {
        ...
        parameters.add(new RequestParameterBuilder()
                .name("AppKey")
                .description("tech.pdai.springboot.shardingjdbc.mybatis.tables.App Key")
                .required(false)
